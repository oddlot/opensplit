...
import io.oddlot.opensplit.adapters.MyExpenseRecyclerViewAdapter
import io.oddlot.opensplit.R
import io.oddlot.opensplit.dummy.DummyContent
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyExpenseRecyclerViewAdapter(DummyContent.ITEMS)
            }
        }
        return view
    }
